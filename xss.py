...
epilog="""
Github: https://github.com/YogeshDiware/XSS-Scanner
Version: 0.5 Final
"""
def check(getopt):
...
def start():
	parse=argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,usage="XSS -u <target> [options]",epilog=epilog,add_help=False)
